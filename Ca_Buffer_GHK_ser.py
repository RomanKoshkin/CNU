...
# CaP_ro = 35 * 3.8e13  # density per square meter
CaP_ro = float(sys.argv[3]) * 35.0 * 3.8e13  # density per square metera
...
i = -1
for dist_bin_id in dist_bin_ids:
    ttime = time.time()
    i += 1
...
fname = 'job_{}_arrayid_{}_Ca_{}'.format(sys.argv[1], sys.argv[2], estCaPcount)
